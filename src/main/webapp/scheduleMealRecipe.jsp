                ...
                <form action="/app/recipe/plan/add" method="post">
                  ...
                  <div class="schedules-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" name="choosePlan">
                                    <c:forEach var="choosePlan" items="${planList}">
                                        <option>${choosePlan.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" value="" name="name" placeholder="Nazwa posiłku">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label  class="col-sm-2 label-size col-form-label">
